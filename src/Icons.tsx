...
const RedBombIcon = iconFactory("times", "#ff0000");
...
const BuildingIcon = iconFactory("hammer", "#996633");
...
const LightningIcon = iconFactory("bolt", "#aaaa00");
...
export {
    ...
    SkullIcon, HelpIcon, StartDisasterIcon, LightningIcon
};
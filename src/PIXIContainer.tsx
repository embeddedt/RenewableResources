        ...
        return <>
            ...
            <PhoneDialog open={this.state.initiallyRendered && !this.state.instructionsHidden} onClose={this.hideInstructions}>
                ...
                <DialogContent>
                    ...
                    <p></p>
                    Some power sources work more efficiently in certain areas than others. For example, windmills are more effective
                    when not surrounded by buildings and trees.
                    <p></p>
                    <strong>Querying tiles</strong>
                    <p></p>
                    Sometimes, you may want to find out how much power is being generated on a tile.
